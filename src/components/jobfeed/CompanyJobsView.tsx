...
export default function CompanyJobsView({ onBack }: Props) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      <View style={styles.headerRow}>
        ...
        <Text style={[styles.title, { color: theme.text }]}>{t.company_jobs_title || 'კომპანიების ვაკანსიები 🏢'}</Text>
      </View>
      ...
      <View style={[styles.searchContainer, { backgroundColor: theme.searchBg }]}>
        ...
        <TextInput
          ...
          placeholder={t.search_company_job_placeholder || "მოძებნე კომპანიის ვაკანსია..."}
      ...
      {/* ================= სორტირების ახალი ინტერაქტიული პანელი ================= */}
